...
;; Consumes the canonical skill model and discovery core to provide invocation,
;; the model-facing tools, local commands, editor support, prompt rosters, and
;; event-shaped reminders.

...
;; Consumes the canonical skill core and invocation module to provide local
;; slash commands, editor support, prompt rosters, event-shaped reminders, and
;; the `gptel-send' dispatch composition that orders local and skill commands.

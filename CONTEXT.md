...
- **execution confinement** — OS-enforced restrictions applied to Bash and batch Eval child processes after permission authorization. It limits process effects but does not decide whether a tool call is allowed.

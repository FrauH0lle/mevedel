...
complete profile; the user may narrow command, network, or exact-path
remembering before settling it.

Reusable approval stores network and exact filesystem requirements on a
...
Exact path authority remains in the shared resource-grant store. A later

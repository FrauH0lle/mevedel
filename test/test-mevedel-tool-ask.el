...
(mevedel-deftest mevedel-tools--ask-question-anchor ()
  ,test
  (test)
        ...
        (cl-letf (((symbol-function 'mevedel--prompt--data-buffer)
          ...
          (with-temp-buffer
            ...
            (let* ((overlay (make-overlay (point-min) (point-max)))
                   (start-0 (mevedel-tools--ask-question-start overlay 0))
                   (start-1 (mevedel-tools--ask-question-start overlay 1))
                   (anchor-0 (mevedel-tools--ask-question-anchor overlay 0))
                   (anchor-1 (mevedel-tools--ask-question-anchor overlay 1))
                   (anchor-2 (mevedel-tools--ask-question-anchor overlay 2)))

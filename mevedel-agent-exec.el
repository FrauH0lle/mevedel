...
;; dispatch and lifecycle state; this module owns the gptel request FSM,
;; transcript buffer execution, and streaming callback contract.
;;
...
`mevedel-agent-runtime--handle-wait-inject' (reminders) so the audit log
